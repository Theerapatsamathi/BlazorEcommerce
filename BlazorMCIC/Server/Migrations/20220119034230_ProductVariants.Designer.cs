...
namespace BlazorMCIC.Server.Migrations
{
    ...
    [Migration("20220119034230_ProductVariants")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorMCIC.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("BlazorMCIC.Shared.ProductVariant", b =>
                {
                    b.HasOne("BlazorMCIC.Shared.Edition", "Edition")
                        .WithMany()
                        .HasForeignKey("EditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorMCIC.Shared.Product", "Product")
                        .WithMany("Variants")
